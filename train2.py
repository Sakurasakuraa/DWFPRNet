...
if __name__ == '__main__':
    ...
    logging.basicConfig(filename=save_path + 'VDTNet2.log',
    ...
    for epochi in tqdm(range(1, epoch + 1)):
        ...
        while rgb is not None:
            ...
            if i % 100 == 0:
                ...
                logging.info(
                    '#TRAIN#:Epoch [{:03d}/{:03d}], Step [{:04d}/{:04d}], Loss1: {:.4f} Loss2: {:.4f} Loss3: {:.4f}  loss4:{:.4f}, lr:%7.6f '.
        ...
        with torch.no_grad():
            ...
            if epochi == 1:
                ...
                if mae < best_mae:
                    best_mae = mae
                    best_epoch = epochi
                    torch.save(net.state_dict(), save_path + 'VDTNet_epoch_best9.14_2.pth')
