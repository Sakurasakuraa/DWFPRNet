...
class fuse(nn.Module):
    ...
    def forward(self, in1, in2):
        in3 = torch.cat((in1, in2), dim=1)
        in3 = self.bconv1(in3)
        in3_sa = self.sa(in3)

        in1_sa = in1 * in3_sa + in1
        in2_sa = in2 * in3_sa + in2

        in3_sasa = in3_sa * in3
        in3_sa_ca = self.cie(in3_sasa)
        in1_sa_ca = in1_sa * in3_sa_ca + in1_sa
        in2_sa_ca = in2_sa * in3_sa_ca + in2_sa
        in3_saca = in3_sasa * in3_sa_ca
